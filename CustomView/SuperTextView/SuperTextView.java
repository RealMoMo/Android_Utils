...
import com.hht.adjuster.PressAdjuster;

/**
 * Author:CoorChice
 *
 * RealMo: This is a great view.(import time : 2017/12/27)
 */
 ...
 * @describe  基于Author:CoorChice的SuperTextView
 */
...
//    }
    ...
    if (visibility == VISIBLE) { // raelmo add:解决退到后台，再回到前台动画停止bug。
      cacheRunnableState = true;
      cacheNeedRunState = true;
    } else if (cacheRunnableState && cacheNeedRunState) {
      startAnim();
    }
