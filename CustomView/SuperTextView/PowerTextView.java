 ...
 * @time 2017/12/27 12:33
 * @describe  打造万能的布局满足市面常见的样式TextView
 */
public class PowerTextView extends RelativeLayout {
...
//    private boolean mRightBottomTextBold;
    ...
    public PowerTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void getAttr(AttributeSet attrs) {
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.PowerTextView);

        /////////////////////////////////////////////////
        mLeftTextString = typedArray.getString(R.styleable.PowerTextView_sLeftTextString);
        mLeftTopTextString = typedArray.getString(R.styleable.PowerTextView_sLeftTopTextString);
        mLeftBottomTextString = typedArray.getString(R.styleable.PowerTextView_sLeftBottomTextString);

        mCenterTextString = typedArray.getString(R.styleable.PowerTextView_sCenterTextString);
        mCenterTopTextString = typedArray.getString(R.styleable.PowerTextView_sCenterTopTextString);
        mCenterBottomTextString = typedArray.getString(R.styleable.PowerTextView_sCenterBottomTextString);

        mRightTextString = typedArray.getString(R.styleable.PowerTextView_sRightTextString);
        mRightTopTextString = typedArray.getString(R.styleable.PowerTextView_sRightTopTextString);
        mRightBottomTextString = typedArray.getString(R.styleable.PowerTextView_sRightBottomTextString);

        //////////////////////////////////////////////////

        mLeftTextColor = typedArray.getColor(R.styleable.PowerTextView_sLeftTextColor, defaultColor);
        mLeftTopTextColor = typedArray.getColor(R.styleable.PowerTextView_sLeftTopTextColor, defaultColor);
        mLeftBottomTextColor = typedArray.getColor(R.styleable.PowerTextView_sLeftBottomTextColor, defaultColor);

        mCenterTextColor = typedArray.getColor(R.styleable.PowerTextView_sCenterTextColor, defaultColor);
        mCenterTopTextColor = typedArray.getColor(R.styleable.PowerTextView_sCenterTopTextColor, defaultColor);
        mCenterBottomTextColor = typedArray.getColor(R.styleable.PowerTextView_sCenterBottomTextColor, defaultColor);

        mRightTextColor = typedArray.getColor(R.styleable.PowerTextView_sRightTextColor, defaultColor);
        mRightTopTextColor = typedArray.getColor(R.styleable.PowerTextView_sRightTopTextColor, defaultColor);
        mRightBottomTextColor = typedArray.getColor(R.styleable.PowerTextView_sRightBottomTextColor, defaultColor);

        //////////////////////////////////////////////////


        mLeftTextSize = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sLeftTextSize, defaultSize);
        mLeftTopTextSize = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sLeftTopTextSize, defaultSize);
        mLeftBottomTextSize = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sLeftBottomTextSize, defaultSize);

        mCenterTextSize = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sCenterTextSize, defaultSize);
        mCenterTopTextSize = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sCenterTopTextSize, defaultSize);
        mCenterBottomTextSize = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sCenterBottomTextSize, defaultSize);

        mRightTextSize = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sRightTextSize, defaultSize);
        mRightTopTextSize = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sRightTopTextSize, defaultSize);
        mRightBottomTextSize = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sRightBottomTextSize, defaultSize);

        //////////////////////////////////////////////////
        mLeftTopLines = typedArray.getInt(R.styleable.PowerTextView_sLeftTopLines, defaultMaxLines);
        mLeftLines = typedArray.getInt(R.styleable.PowerTextView_sLeftLines, defaultMaxLines);
        mLeftBottomLines = typedArray.getInt(R.styleable.PowerTextView_sLeftBottomLines, defaultMaxLines);

        mCenterTopLines = typedArray.getInt(R.styleable.PowerTextView_sCenterTopLines, defaultMaxLines);
        mCenterLines = typedArray.getInt(R.styleable.PowerTextView_sCenterLines, defaultMaxLines);
        mCenterBottomLines = typedArray.getInt(R.styleable.PowerTextView_sCenterBottomLines, defaultMaxLines);

        mRightTopLines = typedArray.getInt(R.styleable.PowerTextView_sRightTopLines, defaultMaxLines);
        mRightLines = typedArray.getInt(R.styleable.PowerTextView_sRightLines, defaultMaxLines);
        mRightBottomLines = typedArray.getInt(R.styleable.PowerTextView_sRightBottomLines, defaultMaxLines);

        //////////////////////////////////////////////////

        mLeftTopMaxEms = typedArray.getInt(R.styleable.PowerTextView_sLeftTopMaxEms, defaultMaxEms);
        mLeftMaxEms = typedArray.getInt(R.styleable.PowerTextView_sLeftMaxEms, defaultMaxEms);
        mLeftBottomMaxEms = typedArray.getInt(R.styleable.PowerTextView_sLeftBottomMaxEms, defaultMaxEms);

        mCenterTopMaxEms = typedArray.getInt(R.styleable.PowerTextView_sCenterTopMaxEms, defaultMaxEms);
        mCenterMaxEms = typedArray.getInt(R.styleable.PowerTextView_sCenterMaxEms, defaultMaxEms);
        mCenterBottomMaxEms = typedArray.getInt(R.styleable.PowerTextView_sCenterBottomMaxEms, defaultMaxEms);

        mRightTopMaxEms = typedArray.getInt(R.styleable.PowerTextView_sRightTopMaxEms, defaultMaxEms);
        mRightMaxEms = typedArray.getInt(R.styleable.PowerTextView_sRightMaxEms, defaultMaxEms);
        mRightBottomMaxEms = typedArray.getInt(R.styleable.PowerTextView_sRightBottomMaxEms, defaultMaxEms);

        ////////////////////////////////////////////////

        mLeftGravity = typedArray.getInt(R.styleable.PowerTextView_sLeftViewGravity, default_Gravity);
        mCenterGravity = typedArray.getInt(R.styleable.PowerTextView_sCenterViewGravity, default_Gravity);
        mRightGravity = typedArray.getInt(R.styleable.PowerTextView_sRightViewGravity, default_Gravity);

        mLeftTextGravity = typedArray.getInt(R.styleable.PowerTextView_sLeftTextGravity, default_text_gravity);
        mCenterTextGravity = typedArray.getInt(R.styleable.PowerTextView_sCenterTextGravity, default_text_gravity);
        mRightTextGravity = typedArray.getInt(R.styleable.PowerTextView_sRightTextGravity, default_text_gravity);
        ////////////////////////////////////////////////

        mLeftTvDrawableLeft = typedArray.getDrawable(R.styleable.PowerTextView_sLeftTvDrawableLeft);
        mLeftTvDrawableRight = typedArray.getDrawable(R.styleable.PowerTextView_sLeftTvDrawableRight);
        mCenterTvDrawableLeft = typedArray.getDrawable(R.styleable.PowerTextView_sCenterTvDrawableLeft);
        mCenterTvDrawableRight = typedArray.getDrawable(R.styleable.PowerTextView_sCenterTvDrawableRight);
        mRightTvDrawableLeft = typedArray.getDrawable(R.styleable.PowerTextView_sRightTvDrawableLeft);
        mRightTvDrawableRight = typedArray.getDrawable(R.styleable.PowerTextView_sRightTvDrawableRight);

        mTextViewDrawablePadding = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sTextViewDrawablePadding, default_Margin);
        ////////////////////////////////////////////////

        mLeftTvDrawableWidth = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sLeftTvDrawableWidth, -1);
        mLeftTvDrawableHeight = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sLeftTvDrawableHeight, -1);

        mCenterTvDrawableWidth = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sCenterTvDrawableWidth, -1);
        mCenterTvDrawableHeight = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sCenterTvDrawableHeight, -1);

        mRightTvDrawableWidth = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sRightTvDrawableWidth, -1);
        mRightTvDrawableHeight = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sRightTvDrawableHeight, -1);

        mLeftViewWidth = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sLeftViewWidth, 0);
        ///////////////////////////////////////////////
        mTopDividerLineMarginLR = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sTopDividerLineMarginLR, 0);
        mTopDividerLineMarginLeft = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sTopDividerLineMarginLeft, 0);
        mTopDividerLineMarginRight = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sTopDividerLineMarginRight, 0);

        mBottomDividerLineMarginLR = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sBottomDividerLineMarginLR, 0);
        mBottomDividerLineMarginLeft = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sBottomDividerLineMarginLeft, 0);
        mBottomDividerLineMarginRight = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sBottomDividerLineMarginRight, 0);
        ///////////////////////////////////////////////
        mDividerLineType = typedArray.getInt(R.styleable.PowerTextView_sDividerLineType, default_Divider);
        mDividerLineColor = typedArray.getColor(R.styleable.PowerTextView_sDividerLineColor, mDefaultDividerLineColor);

        mDividerLineHeight = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sDividerLineHeight, dip2px(mContext, 0.5f));
        ////////////////////////////////////////////////
        mLeftViewMarginLeft = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sLeftViewMarginLeft, default_Margin);
        mLeftViewMarginRight = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sLeftViewMarginRight, default_Margin);
        mCenterViewMarginLeft = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sCenterViewMarginLeft, 0);
        mCenterViewMarginRight = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sCenterViewMarginRight, 0);
        mRightViewMarginLeft = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sRightViewMarginLeft, default_Margin);
        mRightViewMarginRight = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sRightViewMarginRight, default_Margin);
        ///////////////////////////////////////////////
        leftIconWidth = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sLeftIconWidth, 0);
        leftIconHeight = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sLeftIconHeight, 0);

        rightIconWidth = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sRightIconWidth, 0);
        rightIconHeight = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sRightIconHeight, 0);

        leftIconMarginLeft = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sLeftIconMarginLeft, default_Margin);
        rightIconMarginRight = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sRightIconMarginRight, default_Margin);

        leftIconRes = typedArray.getDrawable(R.styleable.PowerTextView_sLeftIconRes);
        rightIconRes = typedArray.getDrawable(R.styleable.PowerTextView_sRightIconRes);
...
//        mRightBottomTextBold = typedArray.getBoolean(R.styleable.SuperTextView_sRightBottomTextIsBold, false);
        ...
        mLeftTextBackground = typedArray.getDrawable(R.styleable.PowerTextView_sLeftTextBackground);
        mCenterTextBackground = typedArray.getDrawable(R.styleable.PowerTextView_sCenterTextBackground);
        mRightTextBackground = typedArray.getDrawable(R.styleable.PowerTextView_sRightTextBackground);

        //////////////////////////////////////////////
        useRipple = typedArray.getBoolean(R.styleable.PowerTextView_sUseRipple, true);
        mBackground_drawable = typedArray.getDrawable(R.styleable.PowerTextView_sBackgroundDrawableRes);
        ///////////////////////////////////////////////
        mRightViewType = typedArray.getInt(R.styleable.PowerTextView_sRightViewType, -1);
        ////////////////////////////////////////////////
        isChecked = typedArray.getBoolean(R.styleable.PowerTextView_sIsChecked, false);
        rightCheckBoxMarginRight = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sRightCheckBoxMarginRight, default_Margin);
        rightCheckBoxBg = typedArray.getDrawable(R.styleable.PowerTextView_sRightCheckBoxRes);
        //////////////////////////////////////////////////
        rightSwitchMarginRight = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sRightSwitchMarginRight, default_Margin);
        switchIsChecked = typedArray.getBoolean(R.styleable.PowerTextView_sSwitchIsChecked, false);
        mTextOff = typedArray.getString(R.styleable.PowerTextView_sTextOff);
        mTextOn = typedArray.getString(R.styleable.PowerTextView_sTextOn);

        mSwitchMinWidth = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sSwitchMinWidth, 0);
        mSwitchPadding = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sSwitchPadding, 0);
        mThumbTextPadding = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sThumbTextPadding, 0);

        mThumbResource = typedArray.getDrawable(R.styleable.PowerTextView_sThumbResource);
        mTrackResource = typedArray.getDrawable(R.styleable.PowerTextView_sTrackResource);

        centerSpaceHeight = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sCenterSpaceHeight, dip2px(mContext, 5));
        ////////////////////////////////////////////////////
        selectorPressedColor = typedArray.getColor(R.styleable.PowerTextView_sShapeSelectorPressedColor, defaultShapeColor);
        selectorNormalColor = typedArray.getColor(R.styleable.PowerTextView_sShapeSelectorNormalColor, defaultShapeColor);

        solidColor = typedArray.getColor(R.styleable.PowerTextView_sShapeSolidColor, defaultShapeColor);

        cornersRadius = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sShapeCornersRadius, 0);
        cornersTopLeftRadius = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sShapeCornersTopLeftRadius, 0);
        cornersTopRightRadius = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sShapeCornersTopRightRadius, 0);
        cornersBottomLeftRadius = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sShapeCornersBottomLeftRadius, 0);
        cornersBottomRightRadius = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sShapeCornersBottomRightRadius, 0);

        strokeWidth = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sShapeStrokeWidth, 0);
        strokeDashWidth = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sShapeStrokeDashWidth, 0);
        strokeDashGap = typedArray.getDimensionPixelSize(R.styleable.PowerTextView_sShapeStrokeDashGap, 0);

        strokeColor = typedArray.getColor(R.styleable.PowerTextView_sShapeStrokeColor, defaultShapeColor);

        useShape = typedArray.getBoolean(R.styleable.PowerTextView_sUseShape, false);
        mLeftIconShowCircle = typedArray.getBoolean(R.styleable.PowerTextView_sLeftIconShowCircle, false);
        mRightIconShowCircle = typedArray.getBoolean(R.styleable.PowerTextView_sRightIconShowCircle, false);
...
//        setDefaultTextIsBold(rightView, mRightTopTextBold, mRightTextBold, mRightBottomTextBold);
     ...
     * @return 方便链式调用
     */
    public PowerTextView setLeftTopString(CharSequence string) {
        if (leftView != null) {
     ...
     * @return 方便链式调用
     */
    public PowerTextView setLeftString(CharSequence string) {
        if (leftView != null) {
     ...
     * @return 方便链式调用
     */
    public PowerTextView setLeftBottomString(CharSequence string) {
        if (leftView != null) {
     ...
     * @return 方便链式调用
     */
    public PowerTextView setCenterTopString(CharSequence string) {
        if (centerView != null) {
     ...
     * @return 方便链式调用
     */
    public PowerTextView setCenterString(CharSequence string) {
        if (centerView != null) {
     ...
     * @return 方便链式调用
     */
    public PowerTextView setCenterBottomString(CharSequence string) {
        if (centerView != null) {
     ...
     * @return 方便链式调用
     */
    public PowerTextView setRightTopString(CharSequence string) {
        if (rightView != null) {
     ...
     * @return 方便链式调用
     */
    public PowerTextView setRightString(CharSequence string) {
        if (rightView != null) {
     ...
     * @return 方便链式调用
     */
    public PowerTextView setRightBottomString(CharSequence string) {
        if (rightView != null) {
     ...
     */
    public PowerTextView setLeftTopTextColor(int color) {
        if (leftView != null) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setLeftTextColor(int color) {
        if (leftView != null) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setLeftBottomTextColor(int color) {
        if (leftView != null) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setCenterTopTextColor(int color) {
        if (centerView != null) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setCenterTextColor(int color) {
        if (centerView != null) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setCenterBottomTextColor(int color) {
        if (centerView != null) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setRightTopTextColor(int color) {
        if (rightView != null) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setRightTextColor(int color) {
        if (rightView != null) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setRightBottomTextColor(int color) {
        if (rightView != null) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setLeftTopTextIsBold(boolean isBold) {
        if (leftView != null) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setLeftTextIsBold(boolean isBold) {
        if (leftView != null) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setLeftBottomTextIsBold(boolean isBold) {
        if (leftView != null) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setCenterTopTextIsBold(boolean isBold) {
        if (centerView != null) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setCenterTextIsBold(boolean isBold) {
        if (centerView != null) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setCenterBottomTextIsBold(boolean isBold) {
        if (centerView != null) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setRightTopTextIsBold(boolean isBold) {
        if (rightView != null) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setRightTextIsBold(boolean isBold) {
        if (rightView != null) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setRightBottomTextIsBold(boolean isBold) {
        if (rightView != null) {
     ...
     * @return 返回值
     */
    public PowerTextView setCbChecked(boolean checked) {
        isChecked = checked;
        if (rightCheckBox != null) {
     ...
     * @return 返回对象
     */
    public PowerTextView setCbBackground(Drawable drawable) {
     ...
     * @return 返回值
     */
    public PowerTextView setSwitchIsChecked(boolean checked) {
     ...
     */
    public PowerTextView setLeftTvDrawableLeft(Drawable drawableLeft) {
     ...
     */
    public PowerTextView setLeftTvDrawableRight(Drawable drawableRight) {
     ...
     * @param drawableLeft 左边图片资源
     */
    public PowerTextView setCenterTvDrawableLeft(Drawable drawableLeft) {
     ...
     * @param drawableRight 右边图片资源
     */
    public PowerTextView setCenterTvDrawableRight(Drawable drawableRight) {
     ...
     * @param drawableLeft 左边图片资源
     */
    public PowerTextView setRightTvDrawableLeft(Drawable drawableLeft) {
     ...
     * @param drawableRight 右边图片资源
     */
    public PowerTextView setRightTvDrawableRight(Drawable drawableRight) {
     ...
     * @return 返回对象
     */
    public PowerTextView setLeftIcon(Drawable leftIcon) {
        if (leftIconIV != null) {
            leftImgParams.setMargins(leftIconMarginLeft, 0, 0, 0);
     ...
     * @return 返回对象
     */
    public PowerTextView setLeftIcon(int resId) {
        if (leftIconIV != null) {
            leftImgParams.setMargins(leftIconMarginLeft, 0, 0, 0);
     ...
     * @return 返回对象
     */
    public PowerTextView setRightIcon(Drawable rightIcon) {
        if (rightIconIV != null) {
            rightImgParams.setMargins(0, 0, rightIconMarginRight, 0);
     ...
     * @return 返回对象
     */
    public PowerTextView setRightIcon(int resId) {
        if (rightIconIV != null) {
            rightImgParams.setMargins(0, 0, rightIconMarginRight, 0);
     ...
     * @return 对象
     */
    public PowerTextView setSBackground(Drawable drawable) {
        if (drawable != null) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setLeftTextGravity(int gravity) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setCenterTextGravity(int gravity) {
     ...
     * @return SuperTextView
     */
    public PowerTextView setRightTextGravity(int gravity) {
     ...
     * @return superTextView
     */
    public PowerTextView setTopDividerLineVisibility(int visibility) {
        if (topDividerLineView == null) {
            setTopDividerLineView();
        }
     ...
     * @return superTextView
     */
    public PowerTextView setBottomDividerLineVisibility(int visibility) {
        if (bottomDividerLineView == null) {
            setBottomDividerLineView();
        }
     ...
     * @return SuperTextView
     */
    public PowerTextView setOnSuperTextViewClickListener(OnSuperTextViewClickListener onSuperTextViewClickListener) {
        this.superTextViewClickListener = onSuperTextViewClickListener;
        if (superTextViewClickListener != null) {
            this.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    superTextViewClickListener.onClickListener(PowerTextView.this);
                }
            });
        }
        return this;
    ...
    public PowerTextView setLeftTopTvClickListener(OnLeftTopTvClickListener leftTopTvClickListener) {
        this.leftTopTvClickListener = leftTopTvClickListener;
        setDefaultLeftViewClickListener(leftView);
        return this;
    }

    public PowerTextView setLeftTvClickListener(OnLeftTvClickListener leftTvClickListener) {
        this.leftTvClickListener = leftTvClickListener;
        setDefaultLeftViewClickListener(leftView);
        return this;
    }

    public PowerTextView setLeftBottomTvClickListener(OnLeftBottomTvClickListener leftBottomTvClickListener) {
        this.leftBottomTvClickListener = leftBottomTvClickListener;
        setDefaultLeftViewClickListener(leftView);
        return this;
    }

    public PowerTextView setCenterTopTvClickListener(OnCenterTopTvClickListener centerTopTvClickListener) {
        this.centerTopTvClickListener = centerTopTvClickListener;
        setDefaultCenterViewClickListener(centerView);
        return this;
    }

    public PowerTextView setCenterTvClickListener(OnCenterTvClickListener centerTvClickListener) {
        this.centerTvClickListener = centerTvClickListener;
        setDefaultCenterViewClickListener(centerView);
        return this;
    }

    public PowerTextView setCenterBottomTvClickListener(OnCenterBottomTvClickListener centerBottomTvClickListener) {
        this.centerBottomTvClickListener = centerBottomTvClickListener;
        setDefaultCenterViewClickListener(centerView);
        return this;
    }

    public PowerTextView setRightTopTvClickListener(OnRightTopTvClickListener rightTopTvClickListener) {
        this.rightTopTvClickListener = rightTopTvClickListener;
        setDefaultRightViewClickListener(rightView);
        return this;
    }

    public PowerTextView setRightTvClickListener(OnRightTvClickListener rightTvClickListener) {
        this.rightTvClickListener = rightTvClickListener;
        setDefaultRightViewClickListener(rightView);
        return this;
    }

    public PowerTextView setRightBottomTvClickListener(OnRightBottomTvClickListener rightBottomTvClickListener) {
        this.rightBottomTvClickListener = rightBottomTvClickListener;
        setDefaultRightViewClickListener(rightView);
        return this;
    }

    public PowerTextView setLeftImageViewClickListener(OnLeftImageViewClickListener listener) {
    ...
    public PowerTextView setRightImageViewClickListener(final OnRightImageViewClickListener listener) {
    ...
    public PowerTextView setSwitchCheckedChangeListener(OnSwitchCheckedChangeListener switchCheckedChangeListener) {
        this.switchCheckedChangeListener = switchCheckedChangeListener;
        return this;
    }

    public PowerTextView setCheckBoxCheckedChangeListener(OnCheckBoxCheckedChangeListener checkBoxCheckedChangeListener) {
    ...
    public interface OnSuperTextViewClickListener {
        void onClickListener(PowerTextView superTextView);
    }
    ...
    // TODO: 2017/12/28 一下是shape相关属性方法
     ...
     * @return 对象
     */
    public PowerTextView setShapeSelectorPressedColor(int color) {
     ...
     * @return 对象
     */
    public PowerTextView setShapeSelectorNormalColor(int color) {
     ...
     * @return 对象
     */
    public PowerTextView setShapeSolidColor(int color) {
     ...
     * @return 对象
     */
    public PowerTextView setShapeStrokeWidth(int strokeWidth) {
     ...
     * @return 对象
     */
    public PowerTextView setShapeStrokeColor(int strokeColor) {
     ...
     * @return 对象
     */
    public PowerTextView setShapeSrokeDashWidth(float strokeDashWidth) {
     ...
     * @return 对象
     */
    public PowerTextView setShapeStrokeDashGap(float strokeDashGap) {
     ...
     * @return 对象
     */
    public PowerTextView setShapeCornersRadius(float radius) {
     ...
     * @return 对象
     */
    public PowerTextView setShapeCornersTopLeftRadius(float radius) {
     ...
     * @return 对象
     */
    public PowerTextView setShapeCornersTopRightRadius(float radius) {
     ...
     * @return 对象
     */
    public PowerTextView setShapeCornersBottomLeftRadius(float radius) {
     ...
     * @return 对象
     */
    public PowerTextView setShapeCornersBottomRightRadius(float radius) {
