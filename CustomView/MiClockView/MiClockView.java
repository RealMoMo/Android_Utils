...
/**
 * 仿小米时钟
 * 原项目地址：https://github.com/MonkeyMushroom/MiClockView
 *
 * 优化draw时分秒针的代码
 */
public class MiClockView extends View {
    ...
    private void setCameraRotate() {
        ...
        mCamera.restore();
        //camera在view左上角那个点，故旋转默认是以左上角为中心旋转（realmo:important）
        //故在动作之前pre将matrix向左移动getWidth()/2长度，向上移动getHeight()/2长度(realmo:移动到中心)
    ...
    private void getTimeDegree() {
        ...
        float milliSecond = calendar.get(Calendar.MILLISECOND); //[0,999]
...
//        Log.d("realmo","one:"+milliSecond);
//        Log.d("realmo","two:"+second);
//        Log.d("realmo","three:"+minute);
//        Log.d("realmo","four:"+hour);
    }
    ...
    private void drawTimeText() {
        ...
        //TODO x: mTextRect.width() not height???
