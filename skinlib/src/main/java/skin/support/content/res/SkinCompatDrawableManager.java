...
final class SkinCompatDrawableManager {
    ...
    private ColorStateList createSwitchThumbColorStateList(Context context) {
        ...
        if (thumbColor != null && thumbColor.isStateful()) {
            ...
            colors[i] = SkinCompatThemeUtils.getThemeAttrColor(context, android.support.v7.appcompat.R.attr.colorControlActivated);
            i++;
            ...
            // Disabled state
            states[i] = SkinCompatThemeUtils.DISABLED_STATE_SET;
            colors[i] = SkinCompatThemeUtils.getDisabledThemeAttrColor(context, android.support.v7.appcompat.R.attr.colorSwitchThumbNormal);
            i++;
            ...
            // Default enabled state
            states[i] = SkinCompatThemeUtils.EMPTY_STATE_SET;
            colors[i] = SkinCompatThemeUtils.getThemeAttrColor(context, android.support.v7.appcompat.R.attr.colorSwitchThumbNormal);
            i++;
        }
