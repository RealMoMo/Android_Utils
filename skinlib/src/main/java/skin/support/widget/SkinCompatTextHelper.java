...
public class SkinCompatTextHelper extends SkinCompatHelper {
    ...
    public void applySkin() {
        String assetPath = SkinCompatManager.getInstance().getTextTypefacePath(SkinPreference.getInstance().getSkinName());
        Slog.i("assetPath = "+assetPath);
        if (assetPath != null) {
            mView.setTypeface(Typeface.createFromAsset(mView.getContext().getAssets(), assetPath));
        }else{
