...
public class SkinCompatManager extends SkinObservable {
    ...
    public static final int SKIN_RS = 1;
    public static final String SKIN_NAME_RS = "rs_colorful.skin";
    ...
    private HashMap<String, String> textTypefaceAssetPathMap = new HashMap<>();//key = skinName
    ...
    public String getTextTypefacePath(String skinName) {
        if (textTypefaceAssetPathMap == null) {
            return null;
        }
        if (textTypefaceAssetPathMap.containsKey(skinName)) {
            return textTypefaceAssetPathMap.get(skinName);
        }
        return null;
    }

    public void addDefaultTextTypefacePath(String assetPath) {
        textTypefaceAssetPathMap.put("", assetPath);
    }

    public void addTextTypefacePath(String skinName, String assetPath) {
        textTypefaceAssetPathMap.put(skinName, assetPath);
    }
}